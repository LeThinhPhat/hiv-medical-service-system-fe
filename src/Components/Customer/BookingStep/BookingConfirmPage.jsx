...
const BookingConfirmPage = () => {
  ...
  const handleSubmitBooking = async (e) => {
    ...
    try {
      ...
      toast.error(
        "Đặt lịch thất bại: " + (error.message || "Lỗi không xác định")
      );
    } finally {
      setLoading(false);
    }
  ...
  if (!doctor || !slot || !token || !patient?._id)
    return (
      ...
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8 transform transition-all hover:shadow-2xl">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
          ...
          <div className="flex items-center mb-4">
            ...
            <p className="text-lg text-gray-800">
              <span className="font-semibold">Ngày:</span> {formatDate(date)}
            </p>
          </div>
          <div className="flex items-center mb-4">
            <svg
          ...
          <div className="flex items-center">
            ...
            <p className="text-lg text-gray-800">
              <span className="font-semibold">Dịch vụ:</span> {serviceName}
            </p>
          </div>
        </div>
